          ...
          <div className="small_menu">
            <ul>
              ...
              <li className="menu-three">
                <a
                  className="nav-link"
                  href="https://hackernoon.com/u/onyedika"
                  target="_blank"
                >
                  Writing
                </a>
              ...
              <li className="menu-four">
                <a
                  className="nav-link"
                  href="https://drive.google.com/file/d/1mvp127VmxH5b68onmg0gKmxF6DZTIPUE/view?usp=sharing"
                  target="_blank"
                >
                  Resume
                </a>
              ...
              <li className="menu-five">
                <a
                  className="nav-link"
                  href="mailto:edeworonyedika@gmail.com"
                  target="_blank"
                >
                  Contact
                </a>
